...
public class BlockImpl extends EObjectImpl implements Block {
	...
	protected EClass eStaticClass() {
		return CanardPackage.Literals.BLOCK;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CanardPackage.BLOCK__NAME, oldName, name));
	}
	...
	public EList<Attribute> getAttributes() {
		if (attributes == null) {
			attributes = new EObjectContainmentEList<Attribute>(Attribute.class, this, CanardPackage.BLOCK__ATTRIBUTES);
		}
		return attributes;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case CanardPackage.BLOCK__NAME:
				return getName();
			case CanardPackage.BLOCK__ATTRIBUTES:
