 ...
 * @generated
 */
public class CanardSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case CanardPackage.CANARD_MODEL: {
				CanardModel canardModel = (CanardModel)theEObject;
				T result = caseCanardModel(canardModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CanardPackage.TOPIC: {
			...
			case CanardPackage.BLOCK: {
				Block block = (Block)theEObject;
				T result = caseBlock(block);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CanardPackage.REL: {
				Rel rel = (Rel)theEObject;
				T result = caseRel(rel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case CanardPackage.ATTRIBUTE: {
	 ...
	 * @generated
	 */
	public T caseCanardModel(CanardModel object) {
		return null;
	}
