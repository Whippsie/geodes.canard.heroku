...
/**
 * <!-- begin-user-doc -->
 * A representation of the literals of the enumeration '<em><b>Feature Relation Type</b></em>',
 * and utility methods for working with them.
 * <!-- end-user-doc -->
 * @see canard.CanardPackage#getFeatureRelationType()
 * @model
 * @generated
 */
public enum FeatureRelationType implements Enumerator {
	...
	/**
	 * A public read-only list of all the '<em><b>Feature Relation Type</b></em>' enumerators.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	public static final List<FeatureRelationType> VALUES = Collections.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Feature Relation Type</b></em>' literal with the specified literal value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public static FeatureRelationType get(String literal) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FeatureRelationType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Feature Relation Type</b></em>' literal with the specified name.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @param name the name.
	 * @return the matching enumerator or <code>null</code>.
	 * @generated
	 */
	public static FeatureRelationType getByName(String name) {
		for (int i = 0; i < VALUES_ARRAY.length; ++i) {
			FeatureRelationType result = VALUES_ARRAY[i];
	...
	/**
	 * Returns the '<em><b>Feature Relation Type</b></em>' literal with the specified integer value.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	private FeatureRelationType(int value, String name, String literal) {
		this.value = value;
		this.name = name;
